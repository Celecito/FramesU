...
ventana.iconbitmap("pepito.ico")
ventana.geometry("1040x700+250+100")
ventana.resizable(False, False)


frame1 = tkinter.Frame( bg="gray", width=200, height=100)
...
button1 = tkinter.Button(frame3, text="horas")
